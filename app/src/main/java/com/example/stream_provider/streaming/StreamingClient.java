package com.example.stream_provider.streaming;
...
public class StreamingClient extends Activity implements
OnClickListener, 
RtspClient.Callback, 
Session.Callback, 
...
OnCheckedChangeListener {
	...
	public final static String TAG = "StreamingClient";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mButtonVideo = (Button) findViewById(R.id.streamingclient_video);
		mButtonSave = (Button) findViewById(R.id.streamingclient_save);
		mButtonStart = (ImageButton) findViewById(R.id.streamingclient_start);
		mButtonFlash = (ImageButton) findViewById(R.id.streamingclient_flash);
		mButtonCamera = (ImageButton) findViewById(R.id.streamingclient_camera);
		mButtonSettings = (ImageButton) findViewById(R.id.streamingclient_settings);
		mSurfaceView = (SurfaceView) findViewById(R.id.streamingclient_surface);
		mEditTextURI = (EditText) findViewById(R.id.streamingclient_uri);
		mEditTextUsername = (EditText) findViewById(R.id.streamingclient_username);
		mEditTextPassword = (EditText) findViewById(R.id.streamingclient_password);
		mTextBitrate = (TextView) findViewById(R.id.streamingclient_bitrate);
		mLayoutVideoSettings = (FrameLayout) findViewById(R.id.streamingclient_video_layout);
		mLayoutServerSettings = (FrameLayout) findViewById(R.id.streamingclient_server_layout);
		mRadioGroup =  (RadioGroup) findViewById(R.id.streamingclient_radio);
		mProgressBar = (ProgressBar) findViewById(R.id.streamingclient_progress_bar);
		...
		SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(StreamingClient.this);
		if (mPrefs.getString("uri", null) != null) mLayoutServerSettings.setVisibility(View.GONE);
		mEditTextURI.setText(mPrefs.getString("uri", getString(R.string.streamingclient_default_stream)));
	...
	public void onClick(View v) {
		...
		case R.id.streamingclient_start:
			...
			toggleStream();
			break;
		case R.id.streamingclient_flash:
			...
			break;
		case R.id.streamingclient_camera:
			mSession.switchCamera();
			break;
		case R.id.streamingclient_settings:
			...
			break;
		case R.id.streamingclient_video:
			mRadioGroup.clearCheck();
			mLayoutServerSettings.setVisibility(View.GONE);
			mLayoutVideoSettings.setVisibility(View.VISIBLE);
			break;
		case R.id.streamingclient_save:
			mLayoutServerSettings.setVisibility(View.GONE);
			break;
		}
	}
	...
	private void logError(final String msg) {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(StreamingClient.this);
